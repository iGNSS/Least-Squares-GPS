...
%
%   JD = DATE2JD(YEAR, MONTH, DAY, HOUR, MINUTE, SECOND) or
...
if length(varargin)>=2
 ...
 jd.d = day + floor((153*m + 2)/5)  + y*365 + floor(y/4) - floor(y/100) + floor(y/400) - 32045;
 jd.s =  second + 60*minute + 3600*(hour - 12);
 if jd.s < 0
     jd.s = jd.s + 86400;
     jd.d = jd.d - 1;
 end
